...
# Last update on: 16 JUL 2025 #3.1 3105
import math as m
import gc 
import psutil, os
...
def annexA_A1(c,logger,result_table, org_table, pat_table,result_table_A11,  pat_table_A11,
    ...
    annexA_page1_1_4 = "Annex A1a is generated by default, even if the hospital admission data file is unavailable. It may include patients who were not admitted to the hospital during the evaluation period. Annex A1b and Annex A2 are generated only if hospital admission data file is available, and include only patients who had a clinical specimen culture positive for a notifiable bacterium during their admissions to the hospital during the evaluation period." #3.1 3105
    annexA_page1_1 = [annexA_page1_1_1, 
                    add_blankline + annexA_page1_1_2, 
                    add_blankline + annexA_page1_1_3,
                    add_blankline + annexA_page1_1_4]

    annexA_page1_2_1 = "Note: The list of notifiable bacteria included in AMASS was generated based on the literature review and the collaboration with Department of Disease Control, Ministry of Public Health, Thailand. The list could be expanded or modified in future versions of AMASS." #3.1 3105
    ...
    ARC.report_title(c,'Introduction',1.07*inch, 9.5*inch,'#3e4444',font_size=12)
    ARC.report_context(c,annexA_page1_1, 1.0*inch, 3.27*inch, 460, 430,font_size=11) #3.1 3105
    ARC.report_title(c,'Notifiable bacteria under the surveillance',1.07*inch, 4.0*inch,'#3e4444',font_size=12) #3.1 3105
    table_draw = ARC.report_table_annexA_page1(org_table)
    table_draw.wrapOn(c, 700, 700)
    table_draw.drawOn(c, 1.2*inch, 2.3*inch) #3.1 3105
    ...
    if bgotdata_annexA11:
        ...
        ##Page2A (A1.1)
        annexA_page2_A11_1_1 = "After merging microbiology and hospital admission data files, and including only patients who were culture positive for a notifiable bacterium and admitted to the hospital during the evaluation period, the data used to generate the report had:" #3.1 3105
